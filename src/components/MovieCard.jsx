...
import { IconPlayerPlay, IconPlus, IconStar, IconCheck } from '@tabler/icons-react';
  ...
  return (
    ...
    >
      <div className="relative aspect-[2/3] rounded-2xl overflow-hidden shadow-lg shadow-black/50 border border-zinc-800">
        ...
        {/* Quality Badge */}
        <div className="absolute top-3 right-3 px-1.5 py-0.5 bg-indigo-600 text-white text-[8px] font-black rounded uppercase tracking-widest">
          HD
        </div>
      ...
      <div className="mt-4 space-y-1.5 px-1">
        ...
        <div className="flex items-center gap-3 text-[10px] text-zinc-500 font-bold uppercase tracking-wider">
          <span className="text-indigo-500/80">{movie.release_date?.split('-')[0] || movie.first_air_date?.split('-')[0] || '2024'}</span>
